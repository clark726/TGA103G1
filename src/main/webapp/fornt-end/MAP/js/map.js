...
const eqfeed_callback = function (e) {
  for (let i = 0; i < e.features.length; i++) {
    ...
    const content =
      '<div id="content">' +
      "<a class='storename' href='/TGA103G1/back-end/store/store.html' id=" +
      id +
      ">" +
      name +
      "<br>" +
      "</a>" +
      "<a class='theme' href='/TGA103G1/back-end/store/storeType.html' id=" +
      themeId +
      ">" +
      "主題:" +
      theme +
    ...
    .then((response) => {
      ...
      for (var i = 0; i < response.length; i++) {
        ...
        let pro =
          ...
          response[i].produce;
        let work =
          "營業時間：" + response[i].work_open + "~" + response[i].work_end;
        let add = "地址：" + response[i].address + "<br>";
        let f =
          "<div id='" + id + "' class='nf'><img src='./nheart.png'></div>";
        let img = response[i].imgstr;
        $(".store").append(
          "<div class='storeitem' id='" +
            id +
            "'>" +
    ...
    .then((body) => {
      ...
      for (var i = 0; i < body.length; i++) {
        ...
        let name =
          ...
          "</a>";
        let pro =
          " 電話： " + body[i].phone + "<br>" + "介紹：" + body[i].produce;
              ...
              fetch("/TGA103G1/AllTheme", {
                ...
                .then((response) => {
                  for (var i = 0; i < response.length; i++) {
                    ...
                    let work =
                      "營業時間：" +
                      response[i].work_open +
                      "~" +
                      response[i].work_end;
                    let f =
                      "<div id='" +
                      id +
                      "' class='f'><img src='./heart.png'></div>";
                    let img = response[i].imgstr;
                    if (id == d) {
                      $(".store").append(
                        "<div class='storeitem' id='" +
