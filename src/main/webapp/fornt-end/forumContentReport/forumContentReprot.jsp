					...
					<div class="row">
						<div class="col-2" align="center">
							<div class="text shadow p-3 mb-5 bg-body rounded" style="background-color: White; height: 400px ;border: 1px solid black">
								...
								<main style="border: 1px solid black; height: 25px">性別:${userid.gender==1?"女":"男"}
								</main>
								<main style="border: 1px solid black; height: 25px">電子信箱:${userid.email}</main>
							</div>
						</div>
						<div class="col-8" align="center">
							<div class="text shadow p-3 mb-5 bg-body rounded" style="background-color: #FFD382; height: 380px; border: 1px solid black">
								...
								<button type="button" id="alertContentReport" class="btn btn-secondary">確認送出</button>
								<!-- </form> -->
							</div>
						</div>
					</div>
							...
							if (confirm("確認送出?")) {
								...
								$.ajax({
									...
									complete: function (xhr) {
										location.href="/TGA103G1/fornt-end/forum/forum.jsp";
									}
								});
							}
