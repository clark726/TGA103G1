...
<body style="background-color: rgb(129, 93, 65)">
	...
	<div style="background-color: #FFD382; padding: 10px; margin-bottom: 5px;width:;">
		...
		<input id="searchforum" type="text" style="TRANSFORM: TRANSLATEX(555%);">
		<button id="searchbutton" style="TRANSFORM: TRANSLATEX(2200%);">搜尋</button>
		<button id="IWantToInsertContent" style="TRANSFORM: TRANSLATEX(-175%);" class="button">發表文章</button>
	...
	<script>
		...
		var testInput = document.getElementById("searchforum");
		var submitBtn = document.querySelector("#searchbutton");
